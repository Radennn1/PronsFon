    ...
    <div class="bg-white p-8 rounded-lg shadow-md">
        ...
        <form action="{{ route('admin.tugas.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="judul_tugas" id="judul_tugas" value="{{ old('judul_tugas') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
            
            {{-- Dropdown Kategori Standar --}}
            <div class="mb-4">
                <label for="kategori_tugas_id" class="block text-gray-700 font-bold mb-2">Kategori Terkait:</label>
                <select name="kategori_tugas_id" id="kategori_tugas_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
