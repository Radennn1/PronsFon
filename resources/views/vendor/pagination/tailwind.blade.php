                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    {{-- INI BAGIAN TOMBOL AKTIF (WARNA ORANYE) --}}
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-gradient-to-r from-orange-500 to-red-500 border border-orange-500 cursor-default leading-5">{{ $page }}</span>
                                    </span>
                                @else
                                    {{-- INI BAGIAN TOMBOL TIDAK AKTIF --}}
